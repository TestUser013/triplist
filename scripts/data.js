const list = [
    ...
    {item: "Кроссовки", group: "Одежа"},
    {item: "Кружка", group: "Вогонь"},
    {item: "Курточка", group: "Одежа"},
    ...
    {item: "Робочі рукавиці", group: "Одежа"},
    {item: "Розвідний ключ", group: "Інструменти"},
    {item: "Рукавиці", group: "Одежа"},
